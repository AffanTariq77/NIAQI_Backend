...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var basic, premium, premiumPlus;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Seeding membership plans...');
                    return [4 /*yield*/, prisma.membershipPlan.upsert({
                            where: { type: 'BASIC' },
                            update: {},
                            create: {
                ...
                case 3:
                    premiumPlus = _a.sent();
                    console.log('✅ Membership plans seeded:', { basic: basic, premium: premium, premiumPlus: premiumPlus });
                    return [2 /*return*/];
            }
        });
    });
